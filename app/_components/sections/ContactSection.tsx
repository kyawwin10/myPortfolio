    ...
    <section id="contact" className="py-16 sm:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-lg">
          {/* CTA card */}
          <Reveal>
            <div className="section-sheen mb-2 rounded-2xl border border-[#c9c9c9] bg-linear-to-br from-purple-shadow to-blue-popsicle p-6 text-center shadow-[0_20px_56px_rgba(0,0,0,0.2)] sm:mb-8 sm:p-8">
              <div className="flex justify-center items-center text-4xl">
                <img src="/image/handshake-color-icon.png" alt="icon" width={60} height={60} />
              </div>
              <h3 className="mb-2 text-lg font-bold text-[#c9c9c9]">
                Let's Work Together
              </h3>
            ...
            {contactLinks.map(({ icon, label, value, href }, index) => (
              <Reveal key={label} delay={index * 110} variant="left">
                <a
                  ...
                  className="group flex items-center gap-3 rounded-xl border border-[#c9c9c9]/30 bg-purple-shadow p-4 transition-all duration-300 hover:-translate-y-1 sm:gap-4"
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-medium text-[#eeeeee]">{label}</p>
                    <p className="truncate text-sm font-medium text-[#c9c9c9] transition-colors group-hover:text-[#67d9f0]">
                      {value}
                    </p>
                  </div>
                  <svg
                    className="h-4 w-4 shrink-0 text-[#c9c9c9]/50 transition-colors group-hover:text-[#67d9f0]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
